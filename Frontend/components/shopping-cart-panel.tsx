            ...
            cart.map((item, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-lg overflow-hidden border border-neutral-300 dark:border-neutral-700">
                    <img
        ...
        {cart.length > 0 && (
          <>
            ...
            <div className="flex justify-between px-6 pb-6 pt-2">
              <button
                className="px-4 py-2 rounded-lg bg-red-600 text-white hover:bg-red-700 transition-all text-sm shadow-md"
                onClick={handleClearCart}
              >
                Bersihkan
              </button>
              <button
                className="px-4 py-2 rounded-lg bg-amber-600 text-white hover:bg-amber-700 transition-all text-sm shadow-md"
