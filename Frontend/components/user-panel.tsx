...
export default function UserPanel({
  ...
  return (
    <div
      className={`user-panel absolute top-full right-0 w-full md:w-80 lg:w-96 bg-black bg-opacity-80 backdrop-blur-md p-6 rounded-xl shadow-lg transition-all duration-300 transform ${
        isOpen
          ? "translate-y-0 opacity-100"
          : "translate-y-[-10px] opacity-0 pointer-events-none"
      } max-h-[80vh] overflow-y-auto border border-gray-700/50`}
    >
      <style jsx>{`
        @keyframes fadeIn {
          from {
      ...
      {user ? (
        <div className="user-panel-content logged-in animate-fadeIn">
          ...
          <div className="user-menu space-y-2">
            <a
              href="#"
              className="flex items-center space-x-3 p-3 rounded-md text-white text-base menu-hover"
            >
        ...
        <div className="user-panel-content logged-out">
          {showRegisterForm ? (
              ...
              <form id="register-form" onSubmit={handleRegisterSubmit}>
                <div className="input-group mb-4 relative">
                  ...
                  <input
                    ...
                    placeholder="Nama"
                    required
                    className="w-full p-3 pl-10 bg-gray-800 text-white rounded-lg border border-gray-700 focus:outline-none focus:ring-2 focus:ring-[#00AA5B] transition-all duration-200"
            ...
            <div className="login-form animate-fadeIn">
              <h3 className="text-2xl font-semibold mb-5 text-white">Login</h3>
